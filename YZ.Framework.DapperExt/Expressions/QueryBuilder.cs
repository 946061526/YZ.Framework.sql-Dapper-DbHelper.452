    ...
    internal class QueryBuilder<T> where T : class
    {
        ...
        private sealed class PredicateConverter
        {
            ...
            private IPredicate ParseField(BinaryExpression expression)
            {
                ...
                if (TryGetField(expression.Left, out var propertyName))
                ...
                var value = valueExpression.NodeType == ExpressionType.Constant ? ((ConstantExpression)valueExpression).Value : InvokeExpression(valueExpression);
            ...
            {
                if (expression.Method.Name != "Like") throw new NotImplementedException();
            ...
            {
                if (expression.Method.Name != "Contains") throw new NotImplementedException();
